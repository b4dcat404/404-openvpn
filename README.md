...
```bash
curl -O https://raw.githubusercontent.com/b4dcat404/404-openvpn/master/openvpn-install.sh
...
This project is under the [MIT Licence](https://raw.githubusercontent.com/b4dcat404/404-openvpn/master/LICENSE)
